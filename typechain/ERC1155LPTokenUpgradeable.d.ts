...
interface ERC1155LPTokenUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155LPTokenUpgradeable extends Contract {
  ...
  interface: ERC1155LPTokenUpgradeableInterface;
